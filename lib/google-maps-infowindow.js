...
function (_getGoogleClass) {
  ...
  function GoogleMapsInfoWindow(opts) {
    ...
    _this._listeners.push(google.maps.event.addListener(_this.marker, 'click', function () {
      //eslint-disable-line
      !_this.map ? _this.open() : _this.close();
    }));

    _this._listeners.push(google.maps.event.addListener(_this.map_, 'click', function () {
      //eslint-disable-line
      !_this.map || _this.close();
    }));
    ...
    value: function panMap() {
      ...
      if (bounds.contains(position)) {
        setTimeout(function () {
          ...
          var bounding = _this2.anchor.firstChild.getBoundingClientRect();
    ...
    value: function open() {
      ...
      if (this.animated) {
        ...
        (0, _transition.nextFrame)(function () {
          (0, _transition.whenTransitionEnds)(_this3.anchor, false, function () {
            return _this3.enterDone();
          });
        });
      }
